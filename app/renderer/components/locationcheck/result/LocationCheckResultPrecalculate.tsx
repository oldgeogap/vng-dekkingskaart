...
export function LocationCheckResultPrecalculate({ points, coverageFiles }: LocationCheckResultPrecalculateProps) {
  ...
  return (
    <>
      ...
      {!loading && <LocationCheckResultRender coverageFiles={coverageFiles} points={points} entries={entries} />}
    </>
  );
}
